                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 mb-10">
                            <a href="#pricing" className="inline-flex items-center justify-center px-8 py-3.5 text-base font-medium rounded-full text-white bg-primary hover:bg-blue-700 bg-linear-to-r hover:from-primary hover:to-blue-600 shadow-lg shadow-blue-500/30 transition-all hover:-translate-y-0.5">
                                Pesan Sekarang
