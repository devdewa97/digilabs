...
const Process = () => {
    ...
    return (
        <section className="py-24 bg-gradient-to-b from-white to-gray-50/50 border-t border-gray-100">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-4xl mx-auto mb-20">
                    <motion.h2 
                        initial={{ opacity: 0, y: -10 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        className="text-primary font-semibold tracking-wide uppercase text-sm mb-3 bg-gradient-to-r from-primary to-blue-600 bg-clip-text"
                    >
                        Cara Kerja
                    </motion.h2>
                    <motion.h3 
                        ...
                        className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6 leading-tight"
                    >
                ...
                <div className="relative">
                    ...
                    <div className="hidden xl:block absolute top-32 left-16 right-16 h-1 bg-gradient-to-r from-primary/20 via-transparent to-primary/20 z-0"></div>
                            ...
                            >
                                ...
                                <div className="relative bg-white/80 backdrop-blur-xl shadow-2xl border border-white/50 hover:border-primary/30 rounded-3xl p-8 md:p-10 transition-all duration-500 hover:shadow-3xl hover:bg-white/95 lg:hover:scale-[1.02] focus-within:ring-4 ring-primary/20 focus-within:shadow-3xl">
                                    ...
                                    <div className="relative mb-8">
                                        <div className="w-20 h-20 md:w-24 md:h-24 mx-auto bg-gradient-to-br from-primary/10 to-blue-500/10 backdrop-blur-sm border-2 border-primary/20 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-xl">
                                    ...
                                    <div className="text-center space-y-4">
                                        <h4 className="text-2xl md:text-2xl lg:text-xl xl:text-2xl font-bold text-gray-900 group-hover:text-gray-950 transition-colors mb-2 bg-gradient-to-r from-gray-900 to-gray-800 bg-clip-text">
                                            {step.title}
                                        </h4>
